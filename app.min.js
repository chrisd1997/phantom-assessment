...
function w(a){a.preventDefault();a=a.target.querySelector('input[type="url"]');var b=p;console.log(a.getAttribute("data-edit-id"));"edit"===a.getAttribute("data-mode")&&""!==a.getAttribute("data-edit-id")?b[parseInt(a.getAttribute("data-edit-id"))]=a.value:b.push(a.value);x(b);a=document.getElementsByClassName("page-complete")[0];document.getElementsByClassName("page-home")[0].classList.remove("active");a.querySelector("#bookmark-submission").innerText='Your bookmark "'+p.slice(-1)+'" has been added successfully!';
    a.classList.add("active")}function y(a){var b=p.filter(function(d,f){return f===a})[0];if(b){var c=document.getElementById("url");c.value=b;c.setAttribute("data-mode","edit");c.setAttribute("data-edit-id",a.toString());c.focus();document.getElementsByClassName("cancel-edit")[0].classList.add("show")}}function z(a){p.length&&!0===confirm("Are you sure that you want to remove this bookmark?")&&(x(p.filter(function(b,c){return c!==a})),A(),B())}
...
(function(){var a=document.getElementById("url");document.getElementById("add-form").addEventListener("submit",w);a.addEventListener("blur",function(b){return r(b.target)});a.addEventListener("keyup",function(b){return r(b.target)});B();A();document.addEventListener("click",function(b){b.target&&b.target.classList.contains("edit-button")?y(parseInt(b.target.dataset.id)):b.target&&b.target.classList.contains("delete-button")?z(parseInt(b.target.dataset.id)):b.target&&b.target.classList.contains("cancel-edit")&&
    (a.setAttribute("data-mode","new"),a.removeAttribute("data-edit-id"),document.getElementsByClassName("cancel-edit")[0].classList.remove("show"),a.value="",document.querySelector('button[type="submit"]').disabled=!0)})})();